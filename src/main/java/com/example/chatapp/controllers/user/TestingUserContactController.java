...
//    }
    ...
    public ResponseEntity<Object> makeGroupContact(@PathVariable("id") @Schema(example = "1") Long requestingUserId, @RequestBody Set<Long> addableUserIds) throws UserNotFoundException, InsufficientContactMemberException, UserAlreadyInContactException, ContactFullException {
